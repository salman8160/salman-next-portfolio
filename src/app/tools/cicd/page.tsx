...
export default function CicdToolsPage() {
  return (
    <main className="min-h-screen flex flex-col justify-center items-center bg-black text-white px-6">
      <h1 className="text-5xl font-bold mb-4">CI/CD Pipeline Security</h1>
      <p className="text-lg text-gray-400 mb-8">Coming Soon: My Jenkins, GitHub Actions, Terraform, OPA integrations...</p>
      <Link href="/">
